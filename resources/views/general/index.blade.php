        ...
        <div class="row align-items-center bg-animated border border-info rounded">
            <div class="col-lg-6">
                <div class="p-5 text-center text-md-left">
                    ...
                    generating graphs to compare the evolution of physical/cryptocurrencies exchange rates.</p>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="p-5 text-center">
                    ...
                    Central Bank (ECB) regarding physical currencies or dive into cryptocurrencies, courtesy 
                    of Alpha Vantage.</p>
                </div>
